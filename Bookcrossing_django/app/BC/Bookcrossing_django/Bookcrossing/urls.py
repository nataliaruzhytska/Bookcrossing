...
from .views import health_check, index, created, LibraryView, UserView, BookView, BookListView, UserListView, \
    ...
    hide_books, show_books, hide_all_books, show_all_books, add_books_to_read
...
urlpatterns = [
    ...
    path('<slug:slug>/add_user/', UserView.as_view(), name='add_user'),
    ...
    path('users/user_detail/<pk>/books/add_book/', BookView.as_view(), name='add_book'),
